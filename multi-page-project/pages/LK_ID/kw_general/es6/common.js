...
function bindButtonEvents(eventStrCode) {
  ...
  if (sexMaleButton) {
    sexMaleButton.addEventListener("click", () => {
      ...
      kwaiq.instance(aid).track('buttonClick');
      // kwaiq.instance(aid).track('LK_BRA_male');
    });
  }
  ...
  if (sexFemaleButton) {
    sexFemaleButton.addEventListener("click", () => {
      ...
      kwaiq.instance(aid).track('contentView');
      // kwaiq.instance(aid).track('LK_BRA_female');
    });
  }
