...
var pageId = "tourmaline-bubblegum-cef002";
...
function _fetchWaLinks() {
  _fetchWaLinks = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
    var response, data;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          _context.n = 1;
          return fetch("https://ixorsyqhrvytfq5dce22ruz73i0ogttc.lambda-url.ap-southeast-1.on.aws/?_ts=".concat(Date.now()), {
            method: "POST",
            cache: "no-store",
            headers: {
